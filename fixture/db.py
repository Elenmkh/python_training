        ...
        try:
            ...
            for row in cursor:
                ...
                list.append(Contact(id=str(id), firstname=firstname, middlename=middlename, lastname=lastname, nickname=nickname,
                                     company=company, title=title, address=address, home_phone=home, mobile_phone=mobile,
                                     work_phone=work, fax=fax, email=email, email2=email2, email3=email3, homepage=homepage,
                                     b_day=bday, b_month=bmonth, b_year=byear, a_day=aday, a_month=amonth, a_year=ayear,
